  ...
  return (
    ...
    <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
      ...
      <div className='w-full md:w-[50%] mt-6 px-3'>
        <form>
          ...
          className={`mb-6 w-full px-16 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded
    ...
    <div className='mx-w-6xl px-3 mt-6 mx-auto'>
      {!loading && listings.length > 0 && (
        ...
        <ul className='sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 mt-6 mb-6 gap-3'>
